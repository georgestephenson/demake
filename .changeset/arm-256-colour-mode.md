...
It is a _mode_ rather than a change of primary layout, deliberately. `prep` fits
...
_any_ cell may use _any_ colour. The cost is the tile budget, since a 256-colour
