...
| Neo Geo | `neogeo` | `neogeo` | yes | — | — | — | `neogeo` | yes | — | — |
...
- **17** demake music and sound effects; **14** play it from inside a game, and **7** build a cartridge whose only job is one schedule.
