...
| Game Boy Advance | `gba` | `gba` | yes | `bin` `asm` `c` | GNU ARM binutils | mGBA | — | — | — |
| Game Boy Color | `gbc` | `gb` | yes | `bin` `asm` `c` | RGBDS | SameBoy | `gb` | yes | 120 Hz |
| Sega Mega Drive | `md` | `md` | yes | `bin` `asm` `c` | GNU m68k binutils | genesis-plus-gx | — | — | — |
...
| Sega Master System | `sms` | `sms` | yes | `bin` `asm` `c` | WLA-DX | genesis-plus-gx | — | yes | — |
...
| Console | id | family | art | data | ROM | emulator | game | music/sfx | in-game audio |
|---|---|---|---|---|---|---|---|---|---|
| Sega Game Gear | `gg` | `sms` | yes | `bin` `asm` `c` | WLA-DX | genesis-plus-gx | — | yes | — |
...
- **4** compile a Demotic game.
- **7** demake music and sound effects; **4** play it from inside a game.
