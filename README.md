...
| **music** | a MIDI track | chip music, audio that sounds exactly like the hardware will, and a ROM | 18 consoles; 15 play it from inside a game, 9 from a cartridge of its own |
