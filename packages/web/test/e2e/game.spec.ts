...
test("builds and plays a real NES ROM in the page", async ({ page }) => {
  ...
  // The pane waits rather than showing the Game Boy cartridge under an NES
  // heading, and demaking two full-screen pictures in colour is the whole `prep`
  // tournament — which is why this waits on the cartridge's own console.
